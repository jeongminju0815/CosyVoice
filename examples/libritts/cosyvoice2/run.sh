...
cat data/250512_lj_vctk_libri_slx/parquet/data.list > data/train.data.list
cat data/250512_lj_vctk_libri_slx_eval/parquet/data.list > data/dev.data.list
...
for model in hifigan; do
  torchrun --nnodes=1 --nproc_per_node=$num_gpus \
    ...
    --model_dir `pwd`/exp/250512_lj_vctk_libri_slx/origin_hifigan/$train_engine \
    --tensorboard_dir `pwd`/tensorboard/250512_lj_vctk_libri_slx/origin_hifigan/$train_engine \
